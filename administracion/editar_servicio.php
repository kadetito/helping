...
//$seccionactual = filter_input(INPUT_POST, 'seccion');
//$paginaActual = filter_input(INPUT_POST, 'pagina');
//$identificadorregistro= filter_input(INPUT_POST, 'id_come');

$seccionactual = filter_input(INPUT_GET, 'seccion');
$paginaActual = filter_input(INPUT_GET, 'pagina');
$identificadorregistro= filter_input(INPUT_GET, 'idendoregis');
...
//CLASES-----------------------------------------------------------
    ...
    require (ROOT_DIR.'/clases/tipocomercio.class.php'); 
     //servicios
    require (ROOT_DIR.'/clases/servicios.class.php'); 
//WORKERS----------------------------------------------------------  
    //settings
...
// template a usar
//==========================================================
$smarty->display(ROOT_DIR.'/administracion/templates/editar_servicio.tpl');
