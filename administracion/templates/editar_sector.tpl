...
<div class="row"> 
    ...
    <div class="col-6 text-right">
        Comercios > <a href="{$ruta}/administracion/lista_categorias.php">Listado de sectores</a>
    </div>
</div>
                </div>
                <div class="card-body">
...
<input type="hidden" name="id_sect" value="{$getId_seCtor}" />
<input type="hidden" name="pagina" value="{$reciboPagina}" />
<input type="hidden" name="sector" value="{$reciboSector}" />


<div class="row mb-3">
  <div class="col-md-12"><label for="nombre_categoria">Nombre sector</label>
  <input type="text" class="form-control" name="nombre_sector" id="nombre_sector" placeholder="Nombre del sector" value="{$getNombreSect}" /></div>
</div>
