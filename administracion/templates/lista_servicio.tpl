	...
	<div class="modal-dialog modal-sm" role="document">
		<div class="modal-content"><div class="card p-3">
			...
			<div class="modal-body introdatos">
                            ...
                            <input type="hidden" name="pagina" value="lista_servicio" />

                            <div class="row mb-3">
                              <div class="col-md-12"><label for="nombre_catservicio">Nombre categoría servicio</label><input type="text" class="form-control" name="nombre_catservicio" id="nombre_catservicio" placeholder="Nombre de la categoría servicio" value="" required /></div>
                            </div>
