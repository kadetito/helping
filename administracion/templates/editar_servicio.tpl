...
<div class="row"> 
    <div class="col-6"><h4>Lista de Servicios</h4></div>
    <div class="col-6 text-right">
        Comercios > <a href="{$ruta}/administracion/lista_servicios.php">Listado de servicios</a>
    </div>
</div>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-3">
                            <h5 CLASS="fotoseste">FOTOS</H5>

                     <div class="row">
                            <div class="col-md-12">  
                                <em>Las fotos están desactivadas</em>
...
<input type="hidden" name="id_serv" value="{$getId_CatServ}" />
<input type="hidden" name="pagina" value="{$reciboPagina}" />
<input type="hidden" name="sector" value="{$reciboSector}" />


<div class="row mb-3">
  <div class="col-md-12"><label for="nombre_catservicio">Nombre servicio</label>
  <input type="text" class="form-control" name="nombre_catservicio" id="nombre_catservicio" placeholder="Nombre del servicio" value="{$getNombreCatServ}" /></div>
</div>
