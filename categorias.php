...
// CATEGEORIAS 
//
// CATEGORIAS > categorias.php > categorias.tpl
//
// FECHA LOG :   31 ENERO 2019
//
//-----------------------------------------------------------------
error_reporting(E_ALL);
ini_set('display_errors', '1');

$nombreProvincia = $_GET['provincia'];//cojo la provincia del htaccess para llevarla al form del header
$nombreCategoria = $_GET['categoria'];//cojo la categoria del htaccess para usarla
$paginaActual = 'categorias'; //determino en que pagina me hallo para mostrar los anuncios 
...
//WORKERS----------------------------------------------------------  
    ...
    //provincias
    require (ROOT_DIR.'/workers/provincias.worker.php');//recibe los parametros provincia y categoria en cada envio
    //destacados
...
$smarty->assign("nombreProvincia",$nombreProvincia,true);
$smarty->assign("paginaActual",$paginaActual,true);

//=========================================================
// template a usar
//==========================================================
$smarty->display(ROOT_DIR.'/templates/categorias.tpl');
