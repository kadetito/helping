...
<html lang="{$lengua}">
<head>
<title>{*{$TXT_Home}*} {$titulo_general} {$nombreProvinciaHeader} - {$version}</title>
<meta charset="utf-8">
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="description" content="{$metasMetadatos}">
<meta property="og:title" content="{*{$TXT_Home}*} {$titulo_general} {$nombreProvinciaHeader}">
<meta property="og:site_name" content="{$titulo_general}">
<meta property="og:url" content="www.helpingcity.es">
<meta property="og:description" content="{$metasMetadatos}">
...
{include file="templates/introduccion.tpl"}
