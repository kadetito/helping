...
<html lang="{$lengua}">
<head>
<title>{$tituloCategoria} - {$titulo_general} {$nombreProvinciaHeader} - {$version}</title>
<meta charset="utf-8">
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="description" content="{$metasMetadatos}">
<meta property="og:title" content="{$tituloCategoria} - {$titulo_general} {$nombreProvinciaHeader}">
