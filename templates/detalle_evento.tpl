...
<html lang="{$lengua}">
<head>
<title>{$eventoTitulo} - {$titulo_general} {$nombreProvinciaHeader} - {$version}</title>
<meta charset="utf-8">
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="description" content="{$metaTagsEvento}">
<meta property="og:title" content="{$eventoTitulo} ">
<meta property="og:site_name" content="{$titulo_general} {$nombreProvinciaHeader}">
<meta property="og:url" content="www.helpingcity.es">
<meta property="og:description" content="{$metaTagsEvento}">
