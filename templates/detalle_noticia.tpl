...
<html lang="{$lengua}">
<head>
<title>{$notiTitulo} - {$titulo_general} {$nombreProvinciaHeader} - {$version}</title>
<meta charset="utf-8">
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="description" content="{$metaTagsNoticia}">
<meta property="og:title" content="{$notiTitulo}">
<meta property="og:site_name" content="{$titulo_general} {$nombreProvinciaHeader}">
<meta property="og:url" content="www.helpingcity.es">
<meta property="og:description" content="{$metaTagsNoticia}">
