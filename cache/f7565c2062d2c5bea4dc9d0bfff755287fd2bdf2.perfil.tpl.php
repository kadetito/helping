...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5c58dcd9e38e69_65274961',
...
function content_5c58dcd9e38e69_65274961 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
...
/resultados" METHOD="POST" id="search_container_form">
                                                                                            
													
                                                                                                <div class="row">
                                                                                                <div class="col-6" >
                                                                                                    <select name="buscar_provincia" id="busquedaProvincia" class="search_container_input" placeholder="D&oacute;nde?"><option value="" selected>D&oacute;nde?</option><?php echo $_smarty_tpl->tpl_vars['bucleProvinciasSelect']->value;?>
</select>    
                                                                                               </div>
                                                                                                <div class="col-6" >
                                                                                                    <input type="text" name="cadenabusqueda" class="search_container_inpute" placeholder="Buscar" >
                                                                                                    <button type="submit" name="busqueda" class="search_container_button"><i class="fa fa-search" aria-hidden="true"></i></button>
                                                                                                </div>
                                                                                                </div>
...
<?php } elseif ($_smarty_tpl->tpl_vars['paginaActual']->value == "resultado") {?>
	<?php echo $_smarty_tpl->tpl_vars['resultadosBusqueda']->value;?>
