...
$paginaActual = 'resultado'; //determino en que pagina me hallo para mostrar los anuncios 
...
//CLASES-----------------------------------------------------------
    ...
    //busqueda
    require (ROOT_DIR.'/clases/busqueda.class.php');      
//WORKERS----------------------------------------------------------  
    //settings
    ...
    //busqueda
    require (ROOT_DIR.'/workers/busqueda.worker.php'); 
