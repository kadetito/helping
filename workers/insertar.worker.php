...
//                            $id_prov              = filter_input(INPUT_POST, 'id_provincia');             
...
//                            $get_MetodoInsert = new Comercios($id_cate,$id_prov,$id_pobl,$id_tico,$id_sect,$nombre_comercio,$breve_comercio,$descripcion_comercio,$fecha_alta,$email_comercio,$direccion_comercio,$codigo_postal,$telefono_comercio,$fax_comercio,$url_comercio,$facebook_comercio,$twitter_comercio,$instagram_comercio,$youtube_comercio,$ccomercio_destacado,$metas,$guia);
